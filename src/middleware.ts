...
export function middleware() {
  ...
  const csp = [
    ...
    // tidal, github avatars, pokéapi sprites, wikipedia thumbnails, our uploads
    "img-src 'self' data: blob: https://resources.tidal.com https://*.tidal.com https://images.tidal.com https://avatars.githubusercontent.com https://raw.githubusercontent.com https://graph.microsoft.com https://upload.wikimedia.org",
    ...
    "base-uri 'self'",
    "form-action 'self' https://github.com https://login.microsoftonline.com",
  ].join("; ");
